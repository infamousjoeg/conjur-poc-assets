...
2. In the **Folder Name** field, enter `Dev-Team-2`.

### Job1

1. Create a new **Freestyle project** item inside the `Dev-Team-2` folder.
...
1. Create a new **Pipeline** item inside the `Dev-Team-2` folder.
